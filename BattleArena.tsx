...
function BattleArena({
  ...
  return (
    <div className="min-h-screen bg-cyber-dark relative overflow-hidden flex flex-col justify-between p-4 select-none">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-start my-4 flex-1">
        ...
        <div className="font-mono flex flex-col gap-3 self-start">
          ...
          {/* Player Field */}
          <div className="border border-cyber-border/20 rounded-lg p-3 bg-cyber-surface/5">
      ...
      {/* 3. Independent Controls (Turn indicator, Step counter, Draw button, Details) */}
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center gap-2 my-2">
        {/* Step Counter */}
      ...
      {/* Interactive Choice Overlay (fixed full screen) */}
      {showChoiceUI && choiceConfig && (
        <div className="fixed inset-0 z-50 bg-cyber-darker/95 backdrop-blur-md flex flex-col items-center justify-center p-6 border-2 border-neon-magenta/40 rounded-xl animate-fade-in">
