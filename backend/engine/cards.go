...
func AllCards() []models.Card {
	return []models.Card{
		...
		{ID: "a_hermit", Name: "サンドボックス", Attribute: "Mainframe", Power: 2, Rarity: "Common", Effect: "ベンチにセクター（Sector）属性のカードがなければ、パワー+2", EffectType: "hermit", Cost: 2, Deck: "A", Quantity: 4},
		{ID: "a_stable_boy", Name: "サブネットヘルパー", Attribute: "Mainframe", Power: 2, Rarity: "Common", Effect: "ベンチにあるパワー３のカード1枚につき、パワー+1", EffectType: "stable_boy", Cost: 2, Deck: "A", Quantity: 4},
		{ID: "a_pig", Name: "データピッグ", Attribute: "Mainframe", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		
		// Sector (old City)
		{ID: "a_talent", Name: "ネットアイドル", Attribute: "Sector", Power: 2, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		...
		{ID: "a_cow", Name: "サイバーカウ", Attribute: "Orbit", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		...
		{ID: "a_cat", Name: "ネコAI", Attribute: "HoloMedia", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		
		// DeepWeb (old Shipwreck)
		{ID: "a_merman", Name: "DeepWebエンティティ", Attribute: "DeepWeb", Power: 1, Rarity: "Common", Effect: "ベンチにディープウェブ（DeepWeb）属性のカードがあれば、パワー+3", EffectType: "merman", Cost: 2, Deck: "A", Quantity: 4},
		...
		{ID: "a_parrot", Name: "データパロット", Attribute: "DeepWeb", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		...
		{ID: "a_spider", Name: "ウェブクロウラー", Attribute: "Daemon", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		...
		{ID: "a_pony", Name: "サイバーポニー", Attribute: "Matrix", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 4, Deck: "A", Quantity: 3},
		...
		{ID: "b_horse", Name: "サイバーホース", Attribute: "Mainframe", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		...
		{ID: "b_dog", Name: "サイバードッグ", Attribute: "Sector", Power: 3, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		...
		{ID: "b_alien", Name: "ゼノウイルス", Attribute: "Orbit", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		
		// HoloMedia (old Movie)
		{ID: "b_cowboy", Name: "データバガボンド", Attribute: "HoloMedia", Power: 3, Rarity: "Common", Effect: "このカードがフラッグを手に入れたら、相手の山札の一番上のカードをベンチに送る。", EffectType: "cowboy", Cost: 4, Deck: "B", Quantity: 4},
		...
		{ID: "b_lion", Name: "サイバーライオン", Attribute: "HoloMedia", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		...
		{ID: "b_lifeguard", Name: "システムリカバリー", Attribute: "DeepWeb", Power: 4, Rarity: "Common", Effect: "このカードが出たとき、山札の残り枚数が1枚以下なら、パワー+2", EffectType: "lifeguard", Cost: 4, Deck: "B", Quantity: 4},
		{ID: "b_shark", Name: "サイバーシャーク", Attribute: "DeepWeb", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		...
		{ID: "b_teenager", Name: "スクリプトキディ", Attribute: "Daemon", Power: 2, Rarity: "Common", Effect: "ベンチにあるデーモン（Daemon）属性のカード1枚につき、パワー+1", EffectType: "teenager", Cost: 4, Deck: "B", Quantity: 4},
		{ID: "b_necromancer", Name: "リサイクルビン", Attribute: "Daemon", Power: 3, Rarity: "Common", Effect: "ベンチにパワー2のカードがあれば、1枚を山札の一番上に戻して良い。", EffectType: "necromancer", Cost: 4, Deck: "B", Quantity: 4},
		{ID: "b_bat", Name: "サイバーバット", Attribute: "Daemon", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		
		// Matrix (old Fairground)
		{ID: "b_mime", Name: "ミラープログラム", Attribute: "Matrix", Power: 1, Rarity: "Common", Effect: "ベンチの空きの数だけ、パワー+1", EffectType: "mime", Cost: 4, Deck: "B", Quantity: 4},
		{ID: "b_pyrotechnist", Name: "バッファオーバーロード", Attribute: "Matrix", Power: 4, Rarity: "Common", Effect: "このカードが出たとき、山札の残り枚数が1枚以下なら、★+2", EffectType: "pyrotechnist", Cost: 4, Deck: "B", Quantity: 4},
		...
		{ID: "b_duck", Name: "サイバーダック", Attribute: "Matrix", Power: 5, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "B", Quantity: 3},
		...
		{ID: "c_dragon", Name: "コーポドラゴン", Attribute: "Mainframe", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
		
		// Sector (old City)
		{ID: "c_champion", Name: "エリートグラディエーター", Attribute: "Sector", Power: 4, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 3},
		...
		// Orbit (old Space)
		{ID: "c_hologram", Name: "ホログラムデコイ", Attribute: "Orbit", Power: 4, Rarity: "Common", Effect: "このカードを出したら、Bデッキの山札から1枚のカードを見ないで、相手の山札の一番上に置く。", EffectType: "hologram", Cost: 7, Deck: "C", Quantity: 4},
		...
		{ID: "c_slime", Name: "電脳スライム", Attribute: "Orbit", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
		
		// HoloMedia (old Movie)
		{ID: "c_hero", Name: "サイバーヒーロー", Attribute: "HoloMedia", Power: 5, Rarity: "Common", Effect: "このカードがフラッグを手に入れたら、★+3", EffectType: "hero", Cost: 7, Deck: "C", Quantity: 4},
		{ID: "c_trex", Name: "Tウイルスレックス", Attribute: "HoloMedia", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
		...
		// DeepWeb (old Shipwreck)
		{ID: "c_siren", Name: "フィッシングプログラム", Attribute: "DeepWeb", Power: 6, Rarity: "Common", Effect: "相手のベンチのカード1枚を相手の除外エリアに置いても良い。", EffectType: "siren", Cost: 7, Deck: "C", Quantity: 4},
		{ID: "c_kraken", Name: "クラーケンICE", Attribute: "DeepWeb", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
		...
		{ID: "c_werewolf", Name: "電脳ワーウルフ", Attribute: "Daemon", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
		...
		{ID: "c_teddybear", Name: "電脳テディベア", Attribute: "Matrix", Power: 7, Rarity: "Rare", Effect: "", EffectType: "none", Cost: 7, Deck: "C", Quantity: 2},
	}
}
